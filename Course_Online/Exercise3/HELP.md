...
That's all we have to do, but I'm going to add some friendlier feedback at the top of the function. For the special case of "no card number entered" we can give better feedback than "Invalid card". How about:
