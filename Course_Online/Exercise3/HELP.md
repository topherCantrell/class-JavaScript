...
Before we say "Everything is OK" we need to check the date. Then value of the month only matters if we are in the same year (January 2020 is before June 2020 but comparing the years 2021 and 2020, the month is unimportant).
